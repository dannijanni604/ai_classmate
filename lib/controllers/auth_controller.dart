...
import 'package:ai_classmate/views/student_view/student_tabs_view.dart';
import 'package:ai_classmate/views/teacher_view/teacher_home_tabs.dart';
  ...
  Future signUp(BuildContext context) async {
    try {
      ...
      await DB.admins.doc(uid).set({
        ...
        "email": adminEmailController.text,
        "uid": uid,
        "group_id": groupIdController.text.isEmpty
            ? ""
