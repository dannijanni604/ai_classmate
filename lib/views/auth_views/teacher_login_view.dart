...
import 'package:ai_classmate/views/auth_views/teacher_forget_password_view.dart';
import 'package:ai_classmate/views/auth_views/teacher_signup_view.dart';
...
class TeacherLogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Login As Teacher")),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Welcome To AI CLASSMATE", style: Const.labelText()),
                SizedBox(height: Get.size.height * 0.03),
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              appNavPush(
                                context,
                                const TeacherForgetPasswordView(),
                              );
                            },
                            child: const Padding(
